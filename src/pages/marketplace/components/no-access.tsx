 ...
 *
 * The marketplace service answers 403 for an account without `marketplace:editor`, or with an
 * address outside the allowed domain. The wording says what is actually missing and what to do
 * about it, including the part people forget: permissions ride in the access token, so being
 * granted one changes nothing until a fresh token is minted.
 */
