 ...
 *
 * What it asks for is **this console's** client application, not the CMS's. That distinction is the
 * whole reason this screen exists at all — see `src/lib/marketplace/client.ts`.
 */
export const SignIn = () => {
