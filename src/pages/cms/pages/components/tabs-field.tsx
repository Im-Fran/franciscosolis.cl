...
import type {TabDefinition} from "@/lib/pages/types.ts";

/**
 * Which tabs an application turns on.
 *
 * This is the only thing about a page's shape an editor gets to decide, and it is a checklist
 * rather than a layout builder on purpose: every application draws from the same four tabs, so a
            ...
            >
              ...
              <span className="min-w-0">
                <span className="flex items-center gap-1.5 text-sm text-text">
                  {t(`application:tabs.${tab.key}`, {defaultValue: tab.name})}
